...
uint8_t usb0_descriptor_configuration_full_speed[] = {
	...
	USB_WORD(USB_MAX_PACKET_BULK_FS), // wMaxPacketSize
	0x07,                             // bInterval: use the maximum interval possible to avoid congestion
...
uint8_t usb0_descriptor_configuration_high_speed[] = {
	...
	7,                                // bLength
	USB_DESCRIPTOR_TYPE_ENDPOINT,     // bDescriptorType
	0x08,                             // bEndpointAddress: OUT 0x04
	...
	0x03,                             // bmAttributes: INTERRUPT
	USB_WORD(USB_MAX_PACKET_BULK_HS), // wMaxPacketSize
	0x09,                             // bInterval: use the maximum interval possible to avoid congestion
	...
	7,                                // bLength
	USB_DESCRIPTOR_TYPE_ENDPOINT,     // bDescriptorType
	0x07,                             // bEndpointAddress: OUT 0x04
	0x03,                             // bmAttributes: BULK
	USB_WORD(USB_MAX_PACKET_BULK_HS), // wMaxPacketSize
	0x07,                             // bInterval: no NAK
